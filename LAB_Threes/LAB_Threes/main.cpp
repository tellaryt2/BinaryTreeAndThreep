...
/// </summary>
/// <param name="searh">дерево</param>
/// <param name="key">ключ</param>
/// <param name="command">ввденная команда в case</param>
...
void MenuBinaryTree()
{
	...
	while(true)
	{
		...
		int command = GetInteger("введите команду: ");
		switch (command)
		{
			case 1:
			{
				int element = GetInteger("Введите корень дерева: ");
			...
			case 2:
			{
				int element = GetInteger("Введите элемент, который хотите добавить: ");
			...
			case 3:
			{
				int element = GetInteger("Введите элемент, который хотите удалить: ");
			...
			case 6:
			{
				int element = GetInteger("Введите элемент, который хотите найти: ");
...
void MenuTreap()
{
	...
	while(true)
	{
		...
		switch (command)
		{
			case 1:
			{
				int key = GetInteger("введите ключ корня дерева: ");
			...
			case 2:
			{
				int key = GetInteger("введите ключ который хотите добавить: ");
				int priority = GetRand();
			...
			case 4:
			{
				int key = GetInteger("Введите ключ искомого элемента: ");
			...
			case 5:
			{
				int key = GetInteger("Введите ключ элемента: ");
			...
			case 6:
			{
				int key = GetInteger("Введите ключ удаляемого элемента: ");
